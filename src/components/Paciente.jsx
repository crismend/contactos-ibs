...
const Paciente = ({ paciente, setPaciente, eliminarPaciente }) => {
  ...
  const { nombre, propietario, email, alta, sintomas, id, direccion, telefono } = paciente
  ...
  return (
    <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
      <p className="font-bold mb-3 text-gray-700 uppercase">Fecha de contacto: {''}
        <span className="font-normal normal-case  ">{alta}</span>
      </p>

      <p className="font-bold mb-3 text-gray-700 uppercase">Evangelista: {''}
